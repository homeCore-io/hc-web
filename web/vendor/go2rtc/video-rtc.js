/*
 * Vendored from go2rtc v1.9.14 — https://github.com/AlexxIT/go2rtc
 * MIT License, (c) Alexander Sofronov. Unmodified.
 *
 * Why vendored and not fetched from the NVR: the app must not depend on a
 * specific go2rtc build being reachable at runtime to load its own code, and a
 * script fetched cross-origin from the camera server is a supply-chain surface
 * we would not control. Pinned here, inlined at build. Re-fetch with
 * tool/vendor-go2rtc.sh to bump.
 */
/**
